    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auctioneer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='auctions', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('rating',),
                'constraints': [models.UniqueConstraint(fields=('auction', 'rater'), name='unique_rating_per_user')],
            },
        ),
    ]
